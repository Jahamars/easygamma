...
```bash
#wayland
sudo pacman -S gtkmm3 cmake  wayland-protocols gcc libayatana-appindicator

#x11
sudo pacman -S gtkmm3 cmake gcc libayatana-appindicator
...
#x11
sudo apt install libgtkmm-3.0-dev cmake  g++ libayatana-appindicator3-dev
